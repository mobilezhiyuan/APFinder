...
public class Reaction {
	...
	public void setString2transEdge(HashMap<String, ArrayList<Integer>> string2transEdge) {
	...
	public Reaction(String reactionId, String subtrateId, String productId, String subtrateName, String productName,
			double similarity, double freeEnergy, String atomTransfer, ArrayList<Integer> edge, double weight) {
		super();
		this.reactionId = reactionId;
		this.subtrateId = subtrateId;
		this.productId = productId;
